...
export default function MasterContextProvider( { children } ){
    const ContextObject = { BankContext: [kitOneIsActive, setOtherKitActive], DrumKitDataContext: drumKitData, PowerButtonContext: [isPowerOn, setPower], AudioContext: [isPlaying, toggleIsPlaying], VolumeContext: [currentVolume, setCurrentVolume] }
...
ContextObject.BankContext = useState(true);
ContextObject.PowerButtonContext = useState(true);
ContextObject.AudioContext = useState(false);


return(
<MasterContext.Provider value={ContextObject}>
